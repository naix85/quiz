...
public class Hooks {
    ...
    @Parameters({"platform", "platformVersion", "deviceName",  "browserName"})
    @BeforeClass(alwaysRun = true)
    public void launchDriver ( String platform, String platformVersion, String deviceName,String browserName ) {

        if (platform.toLowerCase().equals("android")) {
            LocalDriverManager.setWebDriver(getAndroidDriver(platformVersion, deviceName,browserName));

            DeviceHelper.setDeviceName(deviceName);

        } else {
            LocalDriverManager.setWebDriver(getIOSDriver(platformVersion, deviceName,browserName));
    ...
    private AppiumDriver getIOSDriver ( String platformVersion, String deviceName,String browserName) {
    ...
    private AppiumDriver getAndroidDriver ( String platformVersion, String deviceName, String browserName ) {
        ...
        if (url != null) {
            ...
            capabilities.setCapability(AndroidMobileCapabilityType.CHROMEDRIVER_EXECUTABLE, "/Users/ranjith/node_modules/appium/node_modules/appium-chromedriver/chromedriver/mac/chromedriver");
